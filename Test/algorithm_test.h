...
TEST(inner_product_test) {
  ...
  EXPECT_EQ(std::inner_product(arr2, arr2 + 5, arr3, 0, std::minus<int>(),
                               std::multiplies<int>()),
            mystl::inner_product(arr2, arr2 + 5, arr3, 0, std::minus<int>(),
                                 std::multiplies<int>()));
}
...
TEST(count_test) {
  ...
  EXPECT_EQ(std::count(arr1, arr1 + 9, 2), mystl::count(arr1, arr1 + 9, 2));
  EXPECT_EQ(std::count(arr1, arr1 + 9, 3), mystl::count(arr1, arr1 + 9, 3));
  EXPECT_EQ(std::count(arr1, arr1 + 9, 6), mystl::count(arr1, arr1 + 9, 6));
}
...
TEST(find_first_of_test) {
  ...
  EXPECT_EQ(
      std::find_first_of(arr1, arr1 + 5, arr3, arr3 + 3, std::equal_to<int>()),
...
TEST(sort_test) {
  ...
  int arr3[] = {80, 30, 51, 65, 12, 10, 24, 87, 62, 51,
                32, 45, 1,  33, 66, 20, 35, 84, 62, 14};
  int arr4[] = {80, 30, 51, 65, 12, 10, 24, 87, 62, 51,
                32, 45, 1,  33, 66, 20, 35, 84, 62, 14};
